...
fig_partial <- design_result_partial_interaction$meansplot + 
  labs(title = "Partially attenuated interaction", x = element_blank(), color = element_blank(), y = "outcome value") +
  theme_classic() 
...
fig_full <- design_result_fully_interaction$meansplot + 
  labs(title = "Fully attenuated interaction", x = element_blank(), color = element_blank(), y = "outcome value") +
  theme_classic()
fig_full
...
fig_cross <- design_result_crossover_interaction$meansplot+ 
  labs(title = "Cross-over interaction", x = element_blank(), color = element_blank(), y = "outcome value") +
  theme_classic()
fig_cross
...
#complete figure
Fig1C = cowplot::plot_grid(fig_no, fig_partial, fig_full, fig_cross, nrow = 1)
Fig1C
```
...
Fig1D<- ggplot(data = report3) + 
  ...
  geom_rect(aes(
      ...
      ymin = -1.05,
      ymax = -0.05),
    fill = NA, color = "#21908c", size = 0.5, linetype = "dashed") + 
  geom_rect(aes(
      xmin = -0.05,
      xmax = -1.05,
      ymin = 1.05,
  ...
  geom_rect(aes(
      ...
      ymin = -1.05,
      ymax = -0.05),
    fill = NA, color = "yellow", size = 0.5, linetype = "dashed") +
  geom_rect(aes(
      xmin = 1.05,
      xmax = 0.05,
      ymin = 1.05,
...
```{r}
Fig1_top = cowplot::plot_grid(Fig1A, Fig1B, nrow = 1, labels = c("A", "B"))
Fig1_bottom = cowplot::plot_grid(Fig1D, Fig1E, nrow = 1, labels = c("D", "E"))

Fig1_complete = cowplot::plot_grid(Fig1_top, Fig1C, Fig1_bottom, nrow = 3, labels = c("", "C", ""))
Fig1_complete
ggsave("Figure-1-manuscript.png", width = 40, height = 30, units = "cm")
ggsave("Figure-1-manuscript.tiff", width = 40, height = 30, units = "cm", device = "tiff", dpi = 300)
```